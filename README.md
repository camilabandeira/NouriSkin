...
🔗 [NouriSkin Web App](https://nouriskin-6effcd55f9fe.herokuapp.com/)
...
1. **Delivery Information Form**  
   - Users can update their default delivery details, including:  
     - First and last name.  
     - Street address (with an optional second line).  
     - Town or city.  
     - County or locality.  
     - Postal code.  
     - Country.  
...
2. **Order History**  
   - Displays a list of past orders, including:  
     ...
     - **Date**: The order's purchase date.  
     - **Total**: The grand total of the order.  
     - **Products**: A detailed list of items in the order with:  
       - Product name, quantity, and price.  
       - Product image (if available), or a placeholder message if no image exists.  
